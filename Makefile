...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Datadog CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Datadog controllers
...
# This target prepares repo for your provider by replacing all "datadog"
